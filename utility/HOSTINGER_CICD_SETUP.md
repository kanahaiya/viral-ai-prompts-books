...
**Before deploying to production, enable PHP cURL on your Hostinger account.**

Payment processing will fail without cURL. See [HOSTINGER_ENABLE_CURL.md](HOSTINGER_ENABLE_CURL.md) for detailed steps.
